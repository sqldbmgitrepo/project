...
(
 name1 number(38,0) NOT NULL,
 Name   NOT NULL,
 CONSTRAINT PK_496 PRIMARY KEY ( name1 )
);
...
(
 ...
 CONSTRAINT PK_DimDate_copy PRIMARY KEY ( DateKey )
)
...
(
 ...
 PromotionKey          number(38,0) NOT NULL,
 DateKey               number(38,0) NOT NULL,
 CONSTRAINT PK_factinternetsales_copy PRIMARY KEY ( ProductKey ),
 CONSTRAINT FK_468 FOREIGN KEY ( PromotionKey ) REFERENCES EDW.DimPromotion ( PromotionKey ),
 CONSTRAINT FK_472 FOREIGN KEY ( DateKey ) REFERENCES EDW.DimDate ( DateKey )
)
COMMENT = 'Fact table to hold Currency Data';
...
(
 ...
 CONSTRAINT FK_464 FOREIGN KEY ( AddressID ) REFERENCES EDW.Address ( AddressID )
);
...
(
 ...
 CarrierTrackingNumber varchar(25),
 CustomerPONumber      varchar(25),
 CONSTRAINT PK_508 PRIMARY KEY ( OrderDateKey ),
